...
parser.add_argument("-a", help="path to dir with fastqs")
parser.add_argument("-b", help="path from fastq dir back to trimmomatic output dir")
...
#Run in fastq dir - output files into trimommatic dir
...
result_1 = run_trimmomatic(sample_db_result, args.a)
 
 
#path to reads 
#../raw_reads_10-3-23/
 
#path back to trim dir
#../2_trimmomatic/
 
#Actual run in trimmomatic dir:
#./2.A_trimmomatic.py -a ../raw_reads_10-3-23 -b ../2_trimmomatic
