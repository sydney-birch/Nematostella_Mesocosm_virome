...
def mv_fq_files(ali_num,next_dir_name):
    ...
    for dir_name in sample_list_result:
        ...
        result = subprocess.run("mv unaligned_{1}_{0}_ali_paired1.fq ../../../{2}/unmapped_fastq_files/unaligned_{1}_{0}_ali_paired1.fastq".format(ali_num,dir_name,next_dir_name), shell=True)
        result = subprocess.run("mv unaligned_{1}_{0}_ali_paired2.fq ../../../{2}/unmapped_fastq_files/unaligned_{1}_{0}_ali_paired2.fastq".format(ali_num,dir_name,next_dir_name), shell=True)
