...
def run_bowtie(ali_num,next_dir_name):
    ...
    for dir_name in sample_list_result:
        ...
        print ("cwd: ", os.getcwd())
        #Run hisat2
        result = subprocess.run("bowtie2 -q -p 12 --very-sensitive-local -x ../../3rd_ali_BT/Nematostella_genome -1 *_paired1.fq -2 *_paired2.fq -S Nematostella_genome_BT_ali_{0}_{1}.sam".format(ali_num,dir_name), shell=True)
